{ lib, config, pkgs, ... }: let 
  cfg = config.myHomeManager.mpv;
in {
  options.myHomeManager.mpv.enable = lib.mkEnableOption "Enable MPV";
  ...
  config = lib.mkIf cfg.enable {
    ...
    xdg.configFile."mpv/script-opts/videoclip.conf".text = ''
      ...
      video_folder_path=/home/color/Videos
      audio_folder_path=/home/color/Music
