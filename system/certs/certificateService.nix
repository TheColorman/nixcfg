{
  ...
  flake.nixosModules.system-certs-certificateService =
    {
      pkgs,
      lib,
      config,
                  ...
                  ExecStartPost =
                    let
                      renewPostrunScript =
                        ...
                        |> map (
                          ...
                          ''
                            ...
                            if [ -e renewed ]; then
                              ...
                              ${lib.optionalString (
                                reloadServices != [ ]
                              ) "systemctl --no-block try-reload-or-restart ${lib.escapeShellArgs reloadServices}"}
                            fi
                        ...
                        |> lib.concatLines;
                    in
                    "+" + (pkgs.writeShellScript "certboy-renew-postrun" renewPostrunScript);
                };
