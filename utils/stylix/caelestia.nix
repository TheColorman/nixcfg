{ inputs, lib, ... }: {
  ...
  # https://github.com/anotherhadi/nixy/blob/d71c9d8169616d5675fad1f55a55acd1ef917948/home/system/caelestia-shell/scheme.nix
  flake.nixosModules.utils-stylix-caelestia =
    ...
    in
    {
      home-manager.users."${username}".programs = lib.mkIf config.my.markers.caelestia.enable {
        caelestia.cli.package = customCli;
      };
    };
}
